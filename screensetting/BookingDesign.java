...
public class BookingDesign extends JPanel
{
    ...
    private JTextField txtDocketNoUpdate;
    private JLabel lblDocketUpdate;
    ...
    public BookingDesign() {
        ...
        pnlMain.add(pnlCenter); // Add ImagePanel as pnlCenter
        ...
        lblCombo1 = new JLabel("Enter the Docket No:");
        ...
        btnApply = new JButton("Search and Modify");
        ...
        btnNew = new JButton("New Consignment");
        ...
        lblDocketUpdate = new JLabel("Trans-Doc-");
        lblDocketUpdate.setBounds(5, 40, 70, 30);
        lblDocketUpdate.setFont(new Font("Arial", Font.BOLD, 12));
        pnlCombo1.add(lblDocketUpdate);

        txtDocketNoUpdate = new JTextField();
        txtDocketNoUpdate.setBounds(75, 40, 190, 30);
        txtDocketNoUpdate.setFont(new Font("Arial", Font.BOLD, 12));
        pnlCombo1.add(txtDocketNoUpdate);
    ...
    public JTextField getcmbCombo1() {
        return txtDocketNoUpdate;
    }

     public JLabel getComboLabel() {
		 return lblDocketUpdate;
	 }
