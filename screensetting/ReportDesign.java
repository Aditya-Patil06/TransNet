...
public class ReportDesign extends JPanel
{
	...
	/*JLabel lblShip1 		;//empty labels used to add images on panels pnlLeft and pnlRight
	JLabel lblShip2 		;
	JLabel lblTruck1 		;
	JLabel lblTruck2 		;
...
// in center panel where blinking label is located
		...
		lblProgramHeading = new JLabel("...Project Name Here ...");
...
//Color Setting where all panels colors are set from ColorSetting Class in appsetting
		...
		lblInfo4.setForeground(Color.BLACK);
		lblInfo5.setForeground(Color.BLACK);
		lblInfo6.setForeground(Color.BLACK);
		lblInfo7.setForeground(Color.BLACK);
