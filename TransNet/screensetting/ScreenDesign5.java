...
public class ScreenDesign5 extends JPanel {
    ...
    public ScreenDesign5() {
        ...
        pnlLeftUp = createPanel(5, 5, 280, 485, Color.WHITE);
        pnlLeftDown = createPanel(5, 495, 280, 290, Color.BLACK);
        pnlApply = createPanel(5, 430, 270, 50, Color.LIGHT_GRAY);
        ...
        // Button panels with provided layout
