...
public class ScreenDesign6 extends JPanel
{
    ...
    private JPanel pnlCombo5;
    private JPanel pnlCombo6;
    ...
    private JComboBox<String> cmbCombo5;
    private JComboBox<String> cmbCombo6;
    ...
    public ScreenDesign6() {
        ...
        // Create all panels with images where applicable
        ...
        // Use ImagePanel for pnlCenter with the mountain landscape
        String centerImagePath = "D:/Aditya_Project_TransNet/Truck/image_Center_1.png";
        pnlCenter = ImagePanel.getPanel(centerImagePath);
        ...
        pnlLeftUp = createPanel(5, 5, 280, 570, Color.WHITE);
        pnlLeftDown = createPanel(2, 580, 290, 205, Color.BLACK);
        // Use ImagePanel for pnlLeftDown with the drone/cityscape image
        String leftDownImagePath = "D:/Aditya_Project_TransNet/Truck/image_Left.jpg";
        pnlLeftDown = ImagePanel.getPanel(leftDownImagePath);
        pnlLeftDown.setBounds(2, 580, 290, 205);
        pnlLeftDown.setLayout(null);
        pnlApply = createPanel(5, 515, 270, 50, Color.LIGHT_GRAY);
        ...
        pnlCombo5 = createPanel(5, 345, 270, 80, Color.LIGHT_GRAY);
        pnlCombo6 = createPanel(5, 430, 270, 80, Color.LIGHT_GRAY);

        // Button panels (aligned with ScreenDesign5 layout)
        ...
        // Use ImagePanel for pnlUI with the truck/logistics image
        pnlUI = new JPanel();
        pnlUI.setBounds(5, 5, 1320, 660);
        pnlUI.setLayout(null);
        pnlUIReport = createPanel(5, 5, 1320, 660, Color.YELLOW);

		String rightImagePath = "D:/Aditya_Project_TransNet/Truck/image_Right.jpg";
		pnlRight = ImagePanel.getPanel(rightImagePath);
        ...
        pnlLeftUp.add(pnlCombo5);
        pnlLeftUp.add(pnlCombo6);
        ...
        // Use ImagePanel for pnlRight with the truck image
        ...
        lblCombo5 = new JLabel("Label is not set");
        lblCombo5.setBounds(5, 5, 260, 30);
        pnlCombo5.add(lblCombo5);

        lblCombo6 = new JLabel("Label is not set");
        lblCombo6.setBounds(5, 5, 260, 30);
    ...
    private void setColors() {
        ...
        pnlCombo5.setBackground(ColorSetting.getBackColorCombo1Pnl());
        pnlCombo6.setBackground(ColorSetting.getBackColorCombo1Pnl());
    ...
    public JPanel getCombo5Panel() { return pnlCombo5; }
    public JPanel getCombo6Panel() { return pnlCombo6; }
    ...
    public JComboBox<String> getcmbCombo5() { return cmbCombo5; }
    public JComboBox<String> getcmbCombo6() { return cmbCombo6; }
    ...
    public JLabel getlblCombo5() { return lblCombo5; }
    public JLabel getlblCombo6() { return lblCombo6; }
