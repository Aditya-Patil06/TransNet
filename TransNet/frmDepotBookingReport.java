...
class frmDepotBookingReport extends JFrame
{
    ReportTool tool;
    JButton btnClose;
    String depotName;
    ...
    frmDepotBookingReport(int depotID, String depotName)
    {
        this.depotName = depotName;
        this.vDepotID = depotID;

        setTitle("Booking Report for Depot: " + depotName);
        setSize(1000, 600);
        setLocation(700, 100);
        setLayout(null);
        ...
        {
            JOptionPane.showMessageDialog(this, "Invalid depot ID.", "Error", JOptionPane.ERROR_MESSAGE);
            dispose();
        }
    ...
    void setColumnsData()
    {
        ...
        clsGeneralBookingReport[] Data = clsGeneralBookingReport.getDepotBookingReportInformation(vDepotID);
        ...
        {
            JOptionPane.showMessageDialog(this, "No booking records found for depot: " + depotName, "Info", JOptionPane.INFORMATION_MESSAGE);
        }
    }

    public static void main(String[] args)
    {
        new frmDepotBookingReport(1, "Test Depot");
    }
}