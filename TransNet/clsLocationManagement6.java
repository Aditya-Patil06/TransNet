...
public class clsLocationManagement6
{
	...
	public static void showclsLocationManagement6(clsLocationManagement6 temp)
	{
	...
	public static clsLocationManagement6 getLocationInfo(int mAreaID)
	{
		return (dlsLocationManagement6.getLocationInfo(mAreaID));
	}
