...
public class clsVillageReport1
{
	...
	public static void showVillageReport1(clsVillageReport1 temp)
	{
	    ...
	    {
	        return (dlsVillage.getVillageReport1Info(mTalukaID));
	    }

	    public static void main(String[] args)
	    {
	        clsVillageReport1[] reportData = clsVillageReport1.getVillageReport1Info(1);
	        for (int i = 0; i < reportData.length; i++)
	        {
	            showVillageReport1(reportData[i]);
	        }
    }
