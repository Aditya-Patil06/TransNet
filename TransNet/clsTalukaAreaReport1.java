public class clsTalukaAreaReport1
{
	...
	public static void getTalukaAreaInfo(clsTalukaAreaReport1 temp)
	{
	...
	{
		return dlsTalukaArea.getTalukaAreaReport1Info(mTalukaAreaID);
	}


	public static void main(String args[])
	{
		clsTalukaAreaReport1[] data =
				clsTalukaAreaReport1.getTalukaAreaReport1Info(1);

		for(int i = 0; i < data.length; i++)
		{
			getTalukaAreaInfo(data[i]);
		}
	}
}